# QEMU KubeEdge Image Evidence - 2026-06-02
...
| Git commit | `6217ce4187ec486840bfdb6ff72085836956caad` |
...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_kubeedge_image_parity/.continuum/test_results/test_results_2026-06-02_14-31-12.json` |
...
```text
/mnt/sdc/continuum_smoke/qemu_kubeedge_image_parity/.continuum/logs/benchmark/2026-06-02_13_46_34_classify-images_metrics_manifest.json
```
