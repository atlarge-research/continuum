# QEMU KubeEdge Software Evidence - 2026-06-02
...
| Git commit | `805bbda1dff84b7272375cad541db26f9f98f4c4` |
...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_kubeedge_software_parity/.continuum/test_results/test_results_2026-06-02_15-04-52.json` |
...
| --- | --- | --- | --- |
| `configs/experiments/parity/qemu_kubeedge_software/06_kubeedge_software.yaml` | PASS | 1884.1s | `exit_code=0`, SSH output found, experiment lock written, state file written, state phase `software`, resume contract matched |
