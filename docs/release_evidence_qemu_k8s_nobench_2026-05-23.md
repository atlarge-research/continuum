# QEMU Kubernetes No-Benchmark Parity Evidence - 2026-05-23
...
| Result summary path | `/home/continuum-smoke/continuum_smoke/qemu_k8s_nobench_parity/.continuum/test_results/test_results_2026-05-23_19-16-03.json` |
...
```text
/home/continuum-smoke/continuum_smoke/qemu_k8s_nobench_parity/.continuum/test_results/test_results_2026-05-23_19-16-03.json
```

| Matrix Row | YAML Config | Result | Evidence |
| --- | --- | --- | --- |
| `P-QEMU-09` | `configs/experiments/parity/qemu_k8s_nobench/09_kubernetes_nobench.yaml` | PASS, 288.4s | `exit_code=0`, `ssh_output_found`, `experiment_lock_written`, `state_file_written`, `state_phase=software`, `resume_contract_match` |
