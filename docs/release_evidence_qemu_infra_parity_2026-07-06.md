...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_infra_parity/.continuum/test_results/test_results_2026-07-06_14-55-21.json` |
...
```text
/mnt/sdc/continuum_smoke/qemu_infra_parity/.continuum/test_results/test_results_2026-07-06_14-55-21.json
```

| Matrix Row | YAML Config | Result | Evidence |
| --- | --- | --- | --- |
| `P-QEMU-01` | `configs/experiments/parity/qemu/01_infraonly_cloud.yaml` | PASS, 62.9s | `exit_code=0`, `experiment_lock_written`, `state_file_written`, `state_phase=infrastructure`, `resume_contract_match` |
| `P-QEMU-02` | `configs/experiments/parity/qemu/02_infraonly_edge.yaml` | PASS, 84.5s | `exit_code=0`, `experiment_lock_written`, `state_file_written`, `state_phase=infrastructure`, `resume_contract_match` |
| `P-QEMU-03` | `configs/experiments/parity/qemu/03_infraonly_endpoint.yaml` | PASS, 143.7s | `exit_code=0`, `experiment_lock_written`, `state_file_written`, `state_phase=infrastructure`, `resume_contract_match` |
| `P-QEMU-04` | `configs/experiments/parity/qemu/04_infraonly_all.yaml` | PASS, 169.6s | `exit_code=0`, `experiment_lock_written`, `state_file_written`, `state_phase=infrastructure`, `resume_contract_match` |
