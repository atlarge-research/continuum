# QEMU OpenFaaS Software Evidence - 2026-05-31
...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_openfaas_software_parity/.continuum/test_results/test_results_2026-05-31_17-51-48.json` |
...
| --- | --- | --- | --- |
| `configs/experiments/parity/qemu_openfaas_software/10_openfaas_software.yaml` | PASS | 1350.0s | `exit_code=0`, SSH output found, experiment lock written, state file written, state phase `software`, resume contract matched |
