# QEMU Endpoint Image Evidence - 2026-07-03
...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_endpoint_image_parity/.continuum/test_results/test_results_2026-07-03_10-25-12.json` |
...
```text
/mnt/sdc/continuum_smoke/qemu_endpoint_image_parity/.continuum/logs/benchmark/2026-07-03_10_17_07_classify-images_metrics_manifest.json
```
