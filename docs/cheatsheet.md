...
| `sudo -n /usr/local/bin/continuum-hostctl prime-registry-cache --suite qemu_openfaas_image_parity` | Prime the full OpenFaaS image parity cache after installing the `2026-07-06-kubecontrol-trace-cache` helper |
