...
P-QEMU-06, P-QEMU-06-SW, P-QEMU-07, P-QEMU-07-SW, P-QEMU-08-SW, and
P-QEMU-10-SW-LOCAL evidence were produced from newer runtime source commits
...
refreshed endpoint software-only row, and
...
claimed VM-backed rows on the current runtime source commit or split the release
