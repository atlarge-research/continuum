# QEMU OpenFaaS Local Application Evidence - 2026-07-03
...
| Result summary path | `/mnt/sdc/continuum_smoke/qemu_openfaas_image_local_parity/.continuum/test_results/test_results_2026-07-03_11-42-13.json` |
| Artifact root | `/mnt/sdc/continuum_smoke/qemu_openfaas_image_local_parity/.continuum/` |
| Benchmark metric manifest | `/mnt/sdc/continuum_smoke/qemu_openfaas_image_local_parity/.continuum/logs/benchmark/2026-07-03_11_01_04_classify-images_metrics_manifest.json` |
