...
software and local application subset evidence were refreshed on later clean
commits, while the earlier M1 and old-main QEMU evidence docs still name the
previous release-candidate source commit. Refresh or intentionally reconcile the
evidence source commits before cutting a release tag.
