...
local application subset evidence was refreshed on commit
`b755ef218e010ae434d37b8adc50829703c6619b`, while the earlier M1 and old-main
QEMU evidence docs still name the previous release-candidate source commit.
Refresh or intentionally reconcile the evidence source commits before cutting a
release tag.
