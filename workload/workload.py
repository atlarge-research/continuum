...
from software.openfaas import openfaas


def get_image_location(config):
    """[INTERFACE] Set registry location/path of containerized applications

    Args:
        config (dict): Parsed configuration
    """
    config["module"]["application"].get_image_location(config)
...
# TODO - in class, and not packages (not even a loop)
# def finish():
