...
class CheckReleasePretagTests(unittest.TestCase):
    ...
    def _write_evidence(
        ...
        evidence_path = root / "docs" / "release_evidence_m1_2026-05-31.md"
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md missing Report",
                    )
                ],
            )
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Verify result="
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Verify command="
            ...
            self.assertEqual(
                ...
                [
                    ...
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md says 'after the "
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Current finding="
                        "'Installed /usr/local/bin/continuum-hostctl does not declare "
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md references missing %s"
                        % (missing_report,),
                    )
                ],
            )
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Report=%r "
                        "must be under %r"
                        % (
                            str(report_path),
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Report=%r but "
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Git commit='abcdef0' "
            ...
            self.assertEqual(
                ...
                [
                    check_release_pretag.PretagIssue(
                        ...
                        "docs/release_evidence_m1_2026-05-31.md Tree state='Dirty "
